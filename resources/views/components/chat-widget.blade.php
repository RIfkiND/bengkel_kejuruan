<button type="button" class="btn chat-btn" data-bs-toggle="modal" data-bs-target="#chat-widget">
    <img src="/Asset/images/faq-logoo.png" alt="Help Icon" style="width: 200px; height: 200px;">
</button>
<div id="chat-widget" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="chatWidgetLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-full-width modal-dialog-scrollable">
        <div class="modal-content" style="border-radius: 10px;">
            <div class="modal-header">
                <h4 class="modal-title" id="chatWidgetLabel">Buku Panduan</h4>
                <form>
                    <div class="customize-input d-flex justify-content-end">
                        <input class="form-control custom-shadow custom-radius border-1 bg-white" type="search"
                ...
                <div class="row">
                    <div class="col-sm-3 mb-2 mb-sm-0">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                            aria-orientation="vertical" style="position: fixed; width: 19%;">
